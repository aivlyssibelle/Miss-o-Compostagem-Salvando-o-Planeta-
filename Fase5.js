function fase5(){
  ...
  fill("FFFFFF")
  textSize(13)
  text("   Qual o nome do adubo da compostagem?", 0, 30, 400, 40)
  ...
  textSize(12)
  fill("FFFFFF")
  text("Composto orgânico",100, 130, 200, 20)
  ...
  textSize(12)
  fill("FFFFFF")
  text("Veneno orgânico",100, 280, 200, 50)
  ...
  image(imagens [33], 140, 160, 110, 100);
  image(imagens [34], 160, 50, 70, 60);
