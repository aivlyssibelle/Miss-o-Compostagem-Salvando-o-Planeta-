function fase1(){
  ...
  text("O que a compostagem produz?", 0, 30, 400, 40)
 ...
 if(mouseX >= 150 && mouseX <= 250 && mouseY >= 250 && mouseY <=280){
  ...
  //imagens da tela 
   ...
   image(imagens [27], 90, 65, 230, 80);
   image(imagens [28], 90, 310, 230, 80);
